...
# 添加框架路径
sys.path.insert(0, '/root/.openclaw/workspace/projects/token_overseas/framework')
...
def test_agent_load(agent_info):
    ...
    config_path = f"/root/.openclaw/workspace/projects/token_overseas/agents/{agent_id}/config.yaml"
...
def main():
    """主函数"""
    print("=" * 60)
    print("🤖 GlobalTokenHub - 智能体加载测试")
    print("=" * 60)
    print(f"测试时间：{datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print(f"测试目标：{len(AGENTS)} 个智能体")
    print(f"项目：国际化数字资产交易平台")
    print("=" * 60)
    ...
    # 保存测试报告
    report_path = '/root/.openclaw/workspace/projects/token_overseas/logs/agent_load_test.json'
