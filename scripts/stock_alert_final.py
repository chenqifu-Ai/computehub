...
class StockAlertFinal:
    ...
    def get_stock_price_fixed(self, stock_code):
        """修复编码问题的股票价格获取"""
        # 腾讯财经接口
            ...
            if response.status_code == 200:
                ...
                if '=' in content:
                    ...
                    if len(parts) > 3:
                        ...
                        print(f"解析成功: {stock_name} - ¥{current_price}")
    ...
    def check_and_alert(self):
        ...
        # 获取华联股份价格
        price = self.get_stock_price_fixed('000882')
